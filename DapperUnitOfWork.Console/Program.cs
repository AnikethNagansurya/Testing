...
namespace DapperUnitOfWork.Console
{
    class Program
    {
        ...
        {
            using(var uow = new UnitOfWork("Data Source=GGKU5DELL1287;Database=EmployeeDB;persist security info=True;user id=sa;password=Welcome2ggk;MultipleActiveResultSets=true;Pooling=true;"))
            {
